...
class DeyeProcessorFactory:
    ...
    def __create_builtin_processors(
        ...
        self.__append_processor(processors, DeyeSetTimeProcessor(logger_config, self.__config.set_time_interval,
                self.__config.set_time_timezone, sensors, modbus)
        )
        ...
        self.__append_processor(
            processors, DeyeBatterySettingsEventProcessor(logger_config, self.__mqtt_client, sensors, modbus)
        )
        return processors
